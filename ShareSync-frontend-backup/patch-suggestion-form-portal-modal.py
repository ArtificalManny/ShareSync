...
backup_path = FILE_PATH.with_suffix(
    FILE_PATH.suffix + f".backup-portal-modal-{datetime.now().strftime('%Y%m%d-%H%M%S')}"
)
backup_path.write_text(original)

new_file = r"""// src/components/suggestions/SuggestionForm.jsx
// ═══════════════════════════════════════════════════════════════════════════════
...
FILE_PATH.write_text(new_file)

print("SuggestionForm portal modal patch applied successfully.")
print(f"Updated file: {FILE_PATH}")
print(f"Backup file:  {backup_path}")
print("")
print("Changed only:")
print("- Moved Submit Suggestion modal into a React portal attached to document.body")
print("- Raised modal z-index above the project navigation/header stack")
print("- Rebuilt modal into header + scrollable body + fixed footer layout")
print("- Gave Submit Suggestion a taller, clearer action button")
print("")
print("No backend files were touched.")
print("No API calls were changed.")
print("No suggestion submit, upload, attachment, validation, or toast logic was changed.")
