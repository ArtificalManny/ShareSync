...
path = Path("src/components/ui/OpenShareLogo.jsx")
...
backup = path.with_suffix(path.suffix + f".backup-logo-upgrade-{stamp}")

shutil.copy2(path, backup)

new_code = r'''import React, { useId } from 'react';
...
print("OpenShare logo upgraded successfully.")
print(f"Updated file: {path}")
print(f"Backup file:  {backup}")
print("")
print("Changed only:")
print("- Replaced the simple orbit mark with a premium gradient orbit logo")
print("- Preserved the existing OpenShareLogo props")
print("- Preserved monochrome support")
print("")
print("No backend files touched.")
print("No routing, auth, navbar, sidebar, or page logic changed.")
