    ...
    >
      ...
      <header className="flow-lane-header flex items-start justify-between gap-2 px-1 pb-2">
        <div className="min-w-0">
          ...
          <div className="mt-0.5 text-[10px] leading-snug text-slate-400 dark:text-zinc-500">
            {meta.description}
          </div>
        </div>
      ...
      <div className="flow-lane-scroll min-h-0 flex-1 space-y-2 overflow-y-auto pr-1">
        ...
        {count === 0 && !isAdding && (
          ...
          >
            ...
            <div className="mt-1 text-[10px] leading-snug text-slate-400 dark:text-zinc-500">
              {meta.emptyBody}
            </div>
          </button>
        )}
