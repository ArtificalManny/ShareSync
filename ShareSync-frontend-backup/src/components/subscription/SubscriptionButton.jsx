...
function FreePlanOrbitGlyph() {
  return (
    <div
      className="relative flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-[conic-gradient(from_155deg,#8b5cf6,#38bdf8,#14b8a6,#8b5cf6)] p-[1.5px] shadow-[0_14px_34px_rgba(139,92,246,0.22)]"
      aria-hidden="true"
    >
      <div className="absolute inset-[1.5px] rounded-[0.65rem] bg-white/95 dark:bg-[#0b1020]/95" />

      <div className="absolute inset-0 bg-cyan-300/35 opacity-70 blur-xl" />
  ...
  return (
    <div className="relative" ref={dropRef}>
      <button
        ...
        className={`relative flex items-center gap-2 rounded-xl py-1.5 pl-3 pr-2.5 text-sm font-medium transition-all duration-200 ${
          isPremium
            ? 'bg-gradient-to-r from-amber-400 via-orange-500 to-violet-600 text-white shadow-sm shadow-amber-500/25 hover:-translate-y-0.5 hover:shadow-md'
            : 'border border-slate-200 bg-white text-slate-600 shadow-sm hover:border-violet-300 dark:border-white/10 dark:bg-white/[0.06] dark:text-zinc-300 dark:hover:border-violet-500/30'
        }`}
        title={titleLabel}
      >
        {isPremium ? (
        ...
        <div className="flex flex-col items-start leading-none">
          ...
          <div className="mt-0.5 h-0.5 w-16 overflow-hidden rounded-full bg-slate-200 dark:bg-white/10">
            <div
      ...
      {showDropdown && (
        <div className="openshare-subscription-menu absolute right-0 top-full z-[100] mt-2 w-80 animate-in overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl duration-200 fade-in slide-in-from-top-2 dark:border-white/10 dark:bg-[#1a1a1f] dark:shadow-none">
          <div
            className={`border-b border-slate-100 px-4 py-3 dark:border-white/[0.06] ${
              isPremium
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex min-w-0 items-center gap-2">
                {isPremium ? (
                  <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-amber-400 to-violet-600 text-white shadow-sm shadow-amber-500/25">
                ...
                {isPremium ? (
                  ...
                  <div className="inline-flex min-w-0 max-w-[172px] items-center gap-1.5 rounded-full border border-violet-200/80 bg-white/95 px-3 py-1.5 shadow-sm ring-1 ring-white/70 dark:border-violet-400/25 dark:bg-[#0b1020]/95 dark:ring-violet-300/10">
                    <span className="shrink-0 whitespace-nowrap text-sm font-black text-slate-950 dark:text-white">
                      {planLabel} Plan
                    </span>

                    <span className="shrink-0 whitespace-nowrap rounded-full border border-violet-200 bg-violet-50 px-2 py-0.5 text-[9px] font-black text-violet-700 dark:border-violet-400/25 dark:bg-violet-400/10 dark:text-violet-200">
                      {refreshAgeLabel}
                    </span>
                  </div>
                )}
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                ...
                {!isPremium && (
                  <button
                    ...
                    className="mr-1 text-[11px] font-bold text-violet-600 transition-colors hover:text-violet-700 dark:text-violet-400"
                  >
                    Upgrade
                  </button>
                )}
          ...
          <div className="border-t border-slate-100 bg-slate-50 px-4 py-3 dark:border-white/[0.06] dark:bg-white/[0.02]">
            <button
              type="button"
              onClick={() => {
                setShowDropdown(false);
              ...
              className="flex w-full items-center justify-between text-sm font-medium text-slate-600 transition-colors hover:text-violet-600 dark:text-zinc-300 dark:hover:text-violet-400"
            >
