  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        console.log('Profile - Profile fetched:', fetchedProfile);
        ...
        setError('Failed to load profile: ' + (err.message || 'User not found.'));
      }
    };
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="projects-section card p-6 glassmorphic mt-6">
          <h2 className="text-2xl font-inter text-holo-blue mb-4 flex items-center">
            <Folder className="w-5 h-5 mr-2 text-holo-pink animate-pulse" /> {isOwnProfile ? 'Your Projects' : `${profile.username}'s Projects`}
          </h2>
