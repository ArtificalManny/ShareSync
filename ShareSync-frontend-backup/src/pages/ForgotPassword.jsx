...
const ForgotPassword = () => {
  ...
  return (
    <div className="forgot-password-container">
      <div className="forgot-password-card card p-6 glassmorphic">
        <h2 className="text-3xl font-orbitron font-bold text-primary-blue mb-6 text-center">Forgot Password</h2>
        {(error || authError) && (
