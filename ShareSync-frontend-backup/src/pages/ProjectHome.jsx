...
import ResponsibilityMapPanel from "../components/project/ResponsibilityMapPanel";
  ...
  return (
    <div className="relative z-10 p-6 md:p-10 max-w-[1640px] mx-auto">
      ...
      <div className="mb-8">
        ...
        {/* openshare-responsibility-map-command-v1 */}
  ...
  const renderViewContent = () => {
    try {
      switch (activeView) {
        ...
        <style className="moves-clean-execution-style">
          {`
            /*
              Moves execution polish:
              - Reduces the heavy gray queue slab
              - Keeps the page feeling tactical/active
              - Preserves contrast on task cards and status cards
            */
            ...
            :where(
              ...
              .moves-view,
              .moves-panel,
              [class*="moves"][class*="shell"],
              [class*="moves"][class*="workspace"],
              [class*="moves"][class*="view"],
              [class*="moves"][class*="panel"]
            ) {
              background:
                radial-gradient(circle at 12% 0%, rgba(139, 92, 246, 0.10), transparent 30%),
                radial-gradient(circle at 92% 8%, rgba(34, 211, 238, 0.11), transparent 34%),
                radial-gradient(circle at 78% 100%, rgba(16, 185, 129, 0.06), transparent 36%),
                linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(248, 250, 252, 0.86)) !important;
              border-color: rgba(203, 213, 225, 0.74) !important;
              box-shadow:
                0 22px 64px rgba(15, 23, 42, 0.09),
                inset 0 1px 0 rgba(255, 255, 255, 0.86) !important;
            }

            /*
              This is the key part: soften old slate/gray blocks inside Moves.
            */
            :where(
              .moves-holo-shell,
              .moves-command-shell,
            ...
            :where(
              ...
              background:
                linear-gradient(135deg, rgba(255, 255, 255, 0.76), rgba(226, 232, 240, 0.56)) !important;
            ...
            :where([class*="border-dashed"]) {
              background:
                linear-gradient(135deg, rgba(255, 255, 255, 0.72), rgba(248, 250, 252, 0.54)) !important;
            ...
            .dark :where(
              ...
              background:
                radial-gradient(circle at 12% 0%, rgba(139, 92, 246, 0.15), transparent 32%),
...
`}
              ...
              <style className="moves-hero-backdrop-fix">
                {`
                  section[data-moves-hero="true"] {
                    background:
                      radial-gradient(circle at 12% 0%, rgba(139, 92, 246, 0.13), transparent 34%),
                      radial-gradient(circle at 88% 12%, rgba(34, 211, 238, 0.14), transparent 38%),
                      linear-gradient(135deg, rgba(255, 255, 255, 0.92), rgba(239, 246, 255, 0.68)) !important;
                    border-color: rgba(196, 181, 253, 0.48) !important;
                    box-shadow:
                  ...
                  section[data-moves-hero="true"] :where(
                    [class*="bg-slate-400"],
                    [class*="bg-slate-500"],
                    [class*="bg-slate-600"],
                    [class*="bg-slate-700"],
                    ...
                    background:
                      linear-gradient(135deg, rgba(255, 255, 255, 0.76), rgba(226, 232, 240, 0.28)) !important;
                    border-color: rgba(203, 213, 225, 0.58) !important;
                  }

                  .dark section[data-moves-hero="true"] {
                    background:
                      radial-gradient(circle at 12% 0%, rgba(139, 92, 246, 0.16), transparent 34%),
                      radial-gradient(circle at 88% 12%, rgba(34, 211, 238, 0.13), transparent 38%),
                      linear-gradient(135deg, rgba(15, 23, 42, 0.94), rgba(2, 6, 23, 0.90)) !important;
                    border-color: rgba(255, 255, 255, 0.08) !important;
                  }
                `}
              ...
              <section className="relative mb-4 overflow-hidden rounded-[24px] border border-violet-200/70 bg-white/80 p-4 shadow-sm backdrop-blur-xl dark:border-white/[0.08] dark:bg-white/[0.035] dark:shadow-none" data-moves-hero="true">
