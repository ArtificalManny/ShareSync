    ...
    <div className="register-container">
      <div className="register-card card p-6 glassmorphic card-3d">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="firstName" className="block text-saffron-yellow mb-2 font-inter flex items-center gap-2">
          ...
          <div className="mb-4">
            <label htmlFor="lastName" className="block text-saffron-yellow mb-2 font-inter flex items-center gap-2">
          ...
          <div className="mb-4">
            <label htmlFor="username" className="block text-saffron-yellow mb-2 font-inter flex items-center gap-2">
