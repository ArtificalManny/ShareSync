...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        // PRESERVED: Keeping Inter and JetBrains
      ...
      colors: {
        // --- NEW METALAB ELEVATION SYSTEM ---
        // These allow for the "spatial intentionality" we discussed
        "metalab": {
          "deep": "#0B0C0E",        /* Base Floor */
          "surface": "#141519",     /* Level 1 */
          "elevated": "#1C1E24",    /* Level 2 (Bento Cards) */
          "overlay": "#252830",     /* Level 3 (Modals) */
      ...
      // PRESERVED: Keeping all your custom spacing, shadows, and animations
      fontSize: {
      ...
      borderRadius: {
        ...
        '2xl': '20px',
        '3xl': '24px',
        '4xl': '32px', // Added for the MetaLab look
      },
      boxShadow: {
