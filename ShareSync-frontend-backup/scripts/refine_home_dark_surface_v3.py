...
BACKUP = ROOT / "src/pages/Home.jsx.bak.before-home-dark-surface-refine-v3"


def fail(message: str) -> None:
    print(f"\n[refine_home_dark_surface_v3] ERROR: {message}")
    sys.exit(1)
...
def main() -> None:
    print("[refine_home_dark_surface_v3] starting")
    ...
    # This appears twice in the current file:
    # 1. StatCard
    # 2. sectionCardClasses base
    edited = replace_all_checked(
        ...
        2,
        "shared Home card surface classes",
    )
...
"""
    ...
    if not BACKUP.exists():
        ...
        print(f"[refine_home_dark_surface_v3] backup created: {BACKUP}")
    else:
        print(f"[refine_home_dark_surface_v3] backup already exists, preserved: {BACKUP}")
    ...
    print("\n[refine_home_dark_surface_v3] complete")
    print("\nNext checks:")
    print("  npm run build")
