...
backup_path = FILE_PATH.with_suffix(
    FILE_PATH.suffix + f".backup-project-home-visual-strike-v3-{datetime.now().strftime('%Y%m%d-%H%M%S')}"
)
...
# ─────────────────────────────────────────────────────────────
# 1. Find the real ProjectHome render root
# ─────────────────────────────────────────────────────────────
...
if "project-home-visual-scope" not in root_tag:
    ...
    if double_match:
        ...
        raise RuntimeError(
            ...
            "No changes were written. Paste the first 20 lines after the main return block."
        )
...
# ─────────────────────────────────────────────────────────────
# 2. Add scoped ProjectHome visual CSS
# ─────────────────────────────────────────────────────────────
style_block = r'''
...
print("ProjectHome visual strike v3 patch applied successfully.")
