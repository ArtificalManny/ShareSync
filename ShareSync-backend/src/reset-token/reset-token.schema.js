...
var ResetToken = function () {
    ...
    var ResetToken = _classThis = /** @class */ (function (_super) {
        __extends(ResetToken_1, _super);
        function ResetToken_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.userId = __runInitializers(_this, _userId_initializers, void 0);
            _this.token = (__runInitializers(_this, _userId_extraInitializers), __runInitializers(_this, _token_initializers, void 0));
            _this.expiresAt = (__runInitializers(_this, _token_extraInitializers), __runInitializers(_this, _expiresAt_initializers, void 0));
            __runInitializers(_this, _expiresAt_extraInitializers);
            return _this;
        }
        return ResetToken_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ResetToken");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _userId_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _token_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true })];
        ...
        ResetToken = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ResetToken = _classThis;
}();
