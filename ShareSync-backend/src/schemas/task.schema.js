...
var Task = function () {
    ...
    var Task = _classThis = /** @class */ (function (_super) {
        ...
        function Task_1() {
            ...
            _this.projectId = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _projectId_initializers, void 0));
            _this.status = (__runInitializers(_this, _projectId_extraInitializers), __runInitializers(_this, _status_initializers, void 0));
            _this.assignee = (__runInitializers(_this, _status_extraInitializers), __runInitializers(_this, _assignee_initializers, void 0)); // Added
            _this.dueDate = (__runInitializers(_this, _assignee_extraInitializers), __runInitializers(_this, _dueDate_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _dueDate_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _assignee_decorators = [(0, mongoose_1.Prop)()];
        _dueDate_decorators = [(0, mongoose_1.Prop)()];
