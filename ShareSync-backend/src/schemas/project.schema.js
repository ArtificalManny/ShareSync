...
var Project = function () {
    ...
    var Project = _classThis = /** @class */ (function (_super) {
        ...
        function Project_1() {
            ...
            _this.ownerId = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _ownerId_initializers, void 0));
            _this.isPublic = (__runInitializers(_this, _ownerId_extraInitializers), __runInitializers(_this, _isPublic_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _isPublic_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
