...
var Activity = function () {
    ...
    var Activity = _classThis = /** @class */ (function (_super) {
        ...
        function Activity_1() {
            ...
            _this.projectId = (__runInitializers(_this, _action_extraInitializers), __runInitializers(_this, _projectId_initializers, void 0));
            _this.taskId = (__runInitializers(_this, _projectId_extraInitializers), __runInitializers(_this, _taskId_initializers, void 0));
            _this.timestamp = (__runInitializers(_this, _taskId_extraInitializers), __runInitializers(_this, _timestamp_initializers, void 0));
    ...
    (function () {
        ...
        _projectId_decorators = [(0, mongoose_1.Prop)()];
        _taskId_decorators = [(0, mongoose_1.Prop)()];
