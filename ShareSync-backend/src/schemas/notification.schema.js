...
var Notification = function () {
    ...
    var Notification = _classThis = /** @class */ (function (_super) {
        ...
        function Notification_1() {
            ...
            _this.message = (__runInitializers(_this, _userId_extraInitializers), __runInitializers(_this, _message_initializers, void 0));
            _this.read = (__runInitializers(_this, _message_extraInitializers), __runInitializers(_this, _read_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _read_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _read_decorators = [(0, mongoose_1.Prop)({ default: false })];
