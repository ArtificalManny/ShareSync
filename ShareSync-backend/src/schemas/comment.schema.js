...
var Comment = function () {
    ...
    var Comment = _classThis = /** @class */ (function (_super) {
        ...
        function Comment_1() {
            ...
            _this.projectId = (__runInitializers(_this, _userId_extraInitializers), __runInitializers(_this, _projectId_initializers, void 0));
            _this.content = (__runInitializers(_this, _projectId_extraInitializers), __runInitializers(_this, _content_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _content_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
