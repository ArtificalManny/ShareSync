// backend/src/projects/share.controller.ts
import {
  Controller,
  Post,
  Get,
...
import { ProjectsService } from './project.service';   // ← CHANGED

@Controller('public/projects')
export class ProjectShareController {
  constructor(private readonly projects: ProjectsService) {}   // ← CHANGED
