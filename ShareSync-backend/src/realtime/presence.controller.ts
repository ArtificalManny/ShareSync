...
export class PresenceController {
  ...
  async updateOwnPresence(
    ...
    if (update.currentProject) presence.currentProject = new Types.ObjectId(update.currentProject);
    ...
    if (update.privacySettings) presence.privacySettings = update.privacySettings;
