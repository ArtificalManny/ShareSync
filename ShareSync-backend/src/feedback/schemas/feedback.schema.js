...
var Feedback = function () {
    ...
    var Feedback = _classThis = /** @class */ (function (_super) {
        __extends(Feedback_1, _super);
        function Feedback_1() {
            ...
            _this.rating = (__runInitializers(_this, _content_extraInitializers), __runInitializers(_this, _rating_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _rating_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _rating_decorators = [(0, mongoose_1.Prop)({ required: true })];
