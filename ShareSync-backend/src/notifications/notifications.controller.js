...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.getNotifications = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.findByUser(userId)];
                });
            });
        };
    ...
    (function () {
        ...
        _getNotifications_decorators = [(0, common_1.Get)(':userId')];
