...
var CommentsService = function () {
    ...
    var CommentsService = _classThis = /** @class */ (function () {
        ...
        CommentsService_1.prototype.create = function (commentData) {
            return __awaiter(this, void 0, void 0, function () {
                var comment;
                return __generator(this, function (_a) {
                    comment = new this.commentModel(__assign(__assign({}, commentData), { createdAt: new Date() }));
                    return [2 /*return*/, comment.save()];
                });
            });
        };
        CommentsService_1.prototype.findByProject = function (projectId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.commentModel.find({ projectId: projectId }).exec()];
                });
            });
        };
